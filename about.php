...
<head>
    <meta charset="utf-8">
    <title>PawFect Home - Pet Care Website Template</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="PawFect Home" name="keywords">
    <meta content="PawFect Home" name="description">
    ...
    <style>
        /* Override green color to #89a07e */
        .bg-secondary {
        ...
        .bg-secondary.bg-gradient {
            background: #89a07e !important;
        }
        .flaticon-cat:before, .flaticon-doctor:before, .flaticon-care:before, .flaticon-dog:before {
            color: #89a07e !important;
        }
        .list-inline .fa-check-double {
            color: #89a07e !important;
        }
    </style>
</head>
    ...
    <div class="container-fluid bg-dark text-white mt-5 py-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            <div class="col-lg-4 col-md-12 mb-5">
                <h1 class="mb-3 display-5 text-capitalize text-white"><span class="text-primary">Paw</span>Fect Home</h1>
            ...
            <div class="col-lg-8 col-md-12">
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <p><i class="fa fa-envelope mr-2"></i>info@pawfecthome.com</p>
        ...
        <div class="row">
            <div class="col-md-6 text-center text-md-left mb-3 mb-md-0">
                <p class="m-0 text-white">
                    &copy; <a class="text-white font-weight-bold" href="#">PawFect Home</a>. All Rights Reserved. Designed by
