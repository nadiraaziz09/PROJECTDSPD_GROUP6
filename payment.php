...
if (isset($_POST['pay'])) {
    ...
    if ($methodChoice === 'qr') {
        ...
        header('Location: qr_payment.php?id=' . $payId . '&amount=' . urlencode(number_format($amount,2)) . '&ref=' . urlencode($orderRef) . '&payer=' . urlencode($payer));
        exit();
    }
    ...
    // Manual online banking transfer
...
page_title('Malaysia Online Banking Payment', 'Pay for pet needs products through FPX, QR code, or manual online banking transfer.');
?>
    ...
    <div class="row">
        <div class="col-lg-5 mb-4">
            ...
            <div class="alert alert-light border mt-3 small">
                <strong>Bank Transfer / QR Account</strong><br>
                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select name="method_choice" id="method_choice" class="custom-select" required>
                            ...
                            <option value="qr">QR Code Payment (DuitNow)</option>
                    ...
                    <div class="alert alert-warning small">
                        Real FPX is prepared in the code, but not active because merchant credentials are empty. Fill <strong>payment_gateway_config.php</strong> with ToyyibPay secret key and category code to activate.
                    </div>
                    <?php endif; ?>
                    ...
                    <div id="qrBox" style="display:none;">
                        <div class="alert alert-info small">
                            ...
                            <strong>DuitNow QR Code</strong><br>
                            Click <em>Proceed to QR Payment</em> below. You will see a QR code to scan with your banking or e-wallet app. After payment, click the receipt button on that page.
                        </div>
                    </div>

                    <div class="alert alert-info small" id="generalInfo">
                        For a live payment website, activate ToyyibPay FPX in the config file. Manual transfer and QR modes work on localhost without a payment gateway account.
                    </div>

                    <button name="pay" class="btn btn-primary btn-lg" id="submitBtn">
                        <i class="fas fa-lock mr-2"></i><span id="submitLabel">Continue Payment</span>
                    </button>
...
<script>
var methodSelect = document.getElementById('method_choice');
...
function updateUI() {
    ...
    manualBox.style.display = (val === 'manual') ? 'block' : 'none';
    qrBox.style.display     = (val === 'qr')     ? 'block' : 'none';
    if (val === 'qr') {
        submitLabel.textContent = 'Proceed to QR Payment';
    } else {
        submitLabel.textContent = 'Continue Payment';
    }
}
